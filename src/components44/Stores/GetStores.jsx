...
const GetStores = () => {
  ...
  const updateData = React.useCallback(
    (name, address) => {
      ...
      if (!storeId) {
        debugger;
        axios
          .post("https://localhost:44362/Store/Addstore", {
            id: storeId,
            name: name,
            address: address,
          })
        ...
        debugger;
        axios
          .put(`https://localhost:44362/store/UpdateStore?Id=${storeId}`, {
            name: name,
            address: address,
          })
          .then(() => {
  ...
  const deleteData = React.useCallback(() => {
    setDeleteOpen((open) => !open);
    axios
      .delete(`https://localhost:44362/Store/DeleteStore?storeID=${storeId}`)
      .then(() => {
        fetchData();
      })
      .catch((err) => {
