...
const GetCustomers = () => {
  ...
  const fetchData = React.useCallback(() => {
    axios
        .get("https://pro-test1.azurewebsites.net:443/customer/GetCustomers")
      .then(({ data }) => {
        setCustomers(data);
      })
      .catch((err) => {
  ...
  const updateData = React.useCallback(
    (name, address) => {
      ...
      if (!customerId) {
        axios
            .post("https://pro-test1.azurewebsites.net:443/customer/AddCustomer", {
            id: customerId,
            name: name,
            address: address,
          })
        ...
        axios
          .put(
            `https://pro-test1.azurewebsites.net:443/customer/UpdateCustomer?Id=${customerId}`,
            {
              name: name,
              address: address,
            }
  ...
  const deleteData = React.useCallback(() => {
    ...
    axios
      .delete(
        `https://pro-test1.azurewebsites.net:443/customer/DeleteCustomer?customerID=${customerId}`
      )
      .then(() => {
        fetchData();
      })
