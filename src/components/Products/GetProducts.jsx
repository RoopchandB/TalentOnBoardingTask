...
const GetProducts = () => {
  ...
  const fetchData = React.useCallback(() => {
    axios
        .get("https://pro-test1.azurewebsites.net:443/product/GetProductList")
      .then(({ data }) => {
        setProducts(data);
      })
      .catch((err) => {
  ...
  const updateData = React.useCallback(
    (name, price) => {
      ...
      if (!productId) {
        debugger;
        axios
            .post("https://pro-test1.azurewebsites.net:443/product/AddProduct", {
            id: productId,
            name: name,
            price: price,
          })
        ...
        debugger;
        axios
            .put(`https://pro-test1.azurewebsites.net:443/product/UpdateProduct?Id=${productId}`, {
            name: name,
            price: price,
          })
          .then(() => {
  ...
  const deleteData = React.useCallback(() => {
    ...
    axios
      .delete(
        `https://pro-test1.azurewebsites.net:443/product/DeleteProduct?productID=${productId}`
      )
      .then(() => {
        fetchData();
      })
