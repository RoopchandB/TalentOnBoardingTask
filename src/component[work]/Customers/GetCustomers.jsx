...
const GetCustomers = () => {
  ...
  const fetchData = React.useCallback(() => {
    axios
      .get("https://localhost:50001/customer/GetCustomers")
      .then(({ data }) => {
        setCustomers(data);
      })
      .catch((err) => {
  ...
  const updateData = React.useCallback(
    (name, address) => {
      ...
      if (!customerId) {
        axios
          .post("https://localhost:50001/customer/AddCustomer", {
            id: customerId,
            name: name,
            address: address,
          })
        ...
        axios
          .put(
            `https://localhost:50001/customer/UpdateCustomer?Id=${customerId}`,
            {
              name: name,
              address: address,
            }
  ...
  const deleteData = React.useCallback(() => {
    ...
    axios
      .delete(
        `https://localhost:50001/customer/DeleteCustomer?customerID=${customerId}`
      )
      .then(() => {
        fetchData();
      })
