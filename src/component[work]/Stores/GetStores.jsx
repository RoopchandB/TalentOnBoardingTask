...
const GetStores = () => {
  ...
  const fetchData = React.useCallback(() => {
    axios
      .get("https://localhost:50001/store/GetStoreList")
      .then(({ data }) => {
        setStores(data);
      })
      .catch((err) => {
  ...
  const updateData = React.useCallback(
    (name, address) => {
      ...
      if (!storeId) {
        debugger;
        axios
          .post("https://localhost:50001/Store/Addstore", {
            id: storeId,
            name: name,
            address: address,
          })
        ...
        debugger;
        axios
          .put(`https://localhost:50001/store/UpdateStore?Id=${storeId}`, {
            name: name,
            address: address,
          })
          .then(() => {
  ...
  const deleteData = React.useCallback(() => {
    setDeleteOpen((open) => !open);
    axios
      .delete(`https://localhost:50001/Store/DeleteStore?storeID=${storeId}`)
      .then(() => {
        fetchData();
      })
      .catch((err) => {
