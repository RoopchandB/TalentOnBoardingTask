...
const GetProducts = () => {
  ...
  const fetchData = React.useCallback(() => {
    axios
      .get("https://localhost:50001/product/GetProductList")
      .then(({ data }) => {
        setProducts(data);
      })
      .catch((err) => {
  ...
  const updateData = React.useCallback(
    (name, price) => {
      ...
      if (!productId) {
        debugger;
        axios
          .post("https://localhost:50001/product/AddProduct", {
            id: productId,
            name: name,
            price: price,
          })
        ...
        debugger;
        axios
          .put(`https://localhost:50001/product/UpdateProduct?Id=${productId}`, {
            name: name,
            price: price,
          })
          .then(() => {
  ...
  const deleteData = React.useCallback(() => {
    ...
    axios
      .delete(
        `https://localhost:50001/product/DeleteProduct?productID=${productId}`
      )
      .then(() => {
        fetchData();
      })
